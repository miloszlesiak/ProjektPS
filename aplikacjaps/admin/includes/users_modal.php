    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title"><b>Dodaj użytkownika</b></h4>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="users_edit.php">
                ...
                <div class="form-group">
                    <label for="edit_email" class="col-sm-3 control-label">Adres email</label>
                ...
                <div class="form-group">
                    <label for="edit_password" class="col-sm-3 control-label">Hasło</label>
                ...
                <div class="form-group">
                    <label for="edit_firstname" class="col-sm-3 control-label">Imię</label>
                ...
                <div class="form-group">
                    <label for="edit_lastname" class="col-sm-3 control-label">Nazwisko</label>
                ...
                <div class="form-group">
                    <label for="edit_contact" class="col-sm-3 control-label">Nr telefonu</label>
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-default btn-flat pull-left" data-dismiss="modal"><i class="fa fa-close"></i> Zamknij</button>
              <button type="submit" class="btn btn-success btn-flat" name="edit"><i class="fa fa-check-square-o"></i> Zaktualizuj</button>
              </form>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title"><b>Usuwanie...</b></h4>
            </div>
            <div class="modal-body">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-default btn-flat pull-left" data-dismiss="modal"><i class="fa fa-close"></i> Zamknij</button>
              <button type="submit" class="btn btn-danger btn-flat" name="delete"><i class="fa fa-trash"></i> Usuń</button>
              </form>
            </div>
        </div>
    </div>
