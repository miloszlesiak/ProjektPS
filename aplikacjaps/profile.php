	        	...
	        	<div class="col-sm-9">
	        						...
	        						<div class="col-sm-9">
	        							<h4><?php echo $user['firstname'].' '.$user['lastname']; ?>
	        								<span class="pull-right">
	        									<a href="#edit" class="btn btn-success btn-flat btn-sm" data-toggle="modal"><i class="fa fa-edit"></i> Edytuj</a>
	        								</span>
	        							</h4>
	        							<h4><?php echo $user['email']; ?></h4>
	        							<h4><?php echo (!empty($user['contact_info'])) ? $user['contact_info'] : 'Brak'; ?></h4>
	        							<h4><?php echo (!empty($user['address'])) ? $user['address'] : 'Brak'; ?></h4>
	        		...
	        		<div class="box box-solid">
	        			<div class="box-header with-border">
	        				<h4 class="box-title"><i class="fa fa-calendar"></i> <b>Historia Transakcji</b></h4>
	        			</div>
	        			<div class="box-body">
