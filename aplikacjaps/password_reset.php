  	...
  	<div class="login-box-body">
    	...
    	<form action="password_new.php?code=<?php echo $_GET['code']; ?>&user=<?php echo $_GET['user']; ?>" method="POST">
      		<div class="form-group has-feedback">
        		<input type="password" class="form-control" name="password" placeholder="Nowe hasło" required>
          ...
          <div class="form-group has-feedback">
            ...
            <span class="glyphicon glyphicon-log-in form-control-feedback"></span>
      		...
      		<div class="row">
    			<div class="col-xs-4">
          			<button type="submit" class="btn btn-primary btn-block btn-flat" name="reset"><i class="fa fa-check-square-o"></i> Zmień hasło</button>
        		</div>
      		</div>
    	</form>
  	</div>
